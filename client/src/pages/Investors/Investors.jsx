            ...
            <div className="investor-gate">
                <div className="investor-gate-container">
                    <div className="investor-gate-logo">
                        <img src="https://mymedicalcabinet.s3.us-east-2.amazonaws.com/logos/mymedicalcabinet600 (1).png" alt="Medifax" className="investor-logo-img investor-logo-desktop" /><img src="https://mymedicalcabinet.s3.us-east-2.amazonaws.com/logos/mymedicalcabinetmobilev1.png" alt="Medifax" className="investor-logo-img investor-logo-mobile" />
                    </div>
            ...
            <nav className="investor-nav">
                <div className="investor-nav-content">
                    <div className="investor-nav-logo">
                        <img src="https://mymedicalcabinet.s3.us-east-2.amazonaws.com/logos/mymedicalcabinet600 (1).png" alt="Medifax" className="investor-nav-logo-img investor-logo-desktop" /><img src="https://mymedicalcabinet.s3.us-east-2.amazonaws.com/logos/mymedicalcabinetmobilev1.png" alt="Medifax" className="investor-nav-logo-img investor-logo-mobile" />
                    </div>
            ...
            <section className="slide slide-title">
                <div className="slide-content">
                    <div className="title-logo">
                        <img src="https://mymedicalcabinet.s3.us-east-2.amazonaws.com/logos/mymedicalcabinet600 (1).png" alt="Medifax" className="investor-title-logo-img investor-logo-desktop" /><img src="https://mymedicalcabinet.s3.us-east-2.amazonaws.com/logos/mymedicalcabinetmobilev1.png" alt="Medifax" className="investor-title-logo-img investor-logo-mobile" />
                    </div>
            ...
            <section className="slide slide-cta">
                <div className="slide-content">
                    <div className="cta-logo">
                        <img src="https://mymedicalcabinet.s3.us-east-2.amazonaws.com/logos/mymedicalcabinet600 (1).png" alt="Medifax" className="investor-cta-logo-img investor-logo-desktop" /><img src="https://mymedicalcabinet.s3.us-east-2.amazonaws.com/logos/mymedicalcabinetmobilev1.png" alt="Medifax" className="investor-cta-logo-img investor-logo-mobile" />
                    </div>
